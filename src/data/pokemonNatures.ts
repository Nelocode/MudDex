...
export const OFFICIAL_POKEMON_NATURES: PokemonNatureInfo[] = [
  ...
  { nameEs: 'Huraña', nameEn: 'Lonely', increasedStat: 'attack', decreasedStat: 'defense', label: 'Huraña (+Atk, -Def)' },
  { nameEs: 'Afable', nameEn: 'Mild', increasedStat: 'specialAttack', decreasedStat: 'defense', label: 'Afable (+SpA, -Def)' },
  { nameEs: 'Amable', nameEn: 'Gentle', increasedStat: 'specialDefense', decreasedStat: 'defense', label: 'Amable (+SpD, -Def)' },
