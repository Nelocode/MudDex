...
export const BossCountersView: React.FC = () => {
  return (
    <div className="space-y-6">
      ...
      {/* Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 via-slate-900/90 to-rose-950/40 border border-slate-800 p-6 sm:p-8">
        ...
        <div className="relative z-10 max-w-3xl space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/30 text-rose-400 text-xs font-semibold">
            ...
            <span>Asistente de Batallas & Raid Counters • Diosesmon</span>
          </div>
