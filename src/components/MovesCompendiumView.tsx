...
export const MovesCompendiumView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-zinc-900 via-zinc-900/90 to-purple-950/40 border border-zinc-800 p-4 sm:p-6 md:p-8">
        ...
        <div className="relative z-10 max-w-3xl space-y-2 sm:space-y-3">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-400 text-[11px] sm:text-xs font-semibold max-w-full truncate">
            <Scroll className="w-3.5 h-3.5 shrink-0" />
            <span className="truncate">Compendio de MTs & Movimientos • Cobblemon</span>
          </div>
